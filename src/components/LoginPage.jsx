    ...
    <div className="d-flex justify-content-center align-items-center vh-100 bg-light">
      <div className="border shadow rounded w-25 p-4">
        <form onSubmit={formik.handleSubmit}>
          <h2 className='text-center  pt-2 pb-4 fw-bold' style={{color:'#000080'}}>Login</h2>
          ...
          <div className="w-100 d-flex ps-2 pe-2 justify-content-center" >
            <button style={{fontSize:'14px'}} className='btn btn-primary mb-2 w-100 mt-2 fw-bold' type="submit">Log in</button>
          </div>
        </form>
        ...
        <div className="w-100 d-flex justify-content-center ps-2 pe-2 pb-2 align-items-center">
          <button  style={{fontSize:'14px'}}  onClick={handleGoogleLogin} className="btn border-primary w-100 fw-bold">
